...
class MGWC {
    ...
    ?>
    <div class="uwc-message error" style="display:none;">
        ...
        <a class="button-primary" style="margin-bottom: 10px;" href="http://codecanyon.net/item/ultimate-woocommerce-expandable-categories/12048496/?ref=dedalx" target="_blank">Update to PRO version to get premium features</a> <a id="uwc-dismiss-notice" class="button-secondary" style="margin-bottom: 10px;" href="javascript:void(0);">Hide this message</a>
        </a>
    </div>
